 ...
 * Pagination library.
 *
 * @version		$Id: pagination.php 244 2010-02-11 17:14:39Z shaun $
 *
 * @package		System
...
class Pagination_Core {
	...
	public function __construct($config = array()) {
		...
		Eight::log('debug', 'Pagination Library initialized');
	}
	 ...
	 */
	public function render($style = nil) {
		// Hide single page pagination
		if($this->auto_hide === YES and $this->total_pages <= 1)
			return '';
	 ...
	 * @return  string
	 */
	public function __call($func, $args = nil) {
