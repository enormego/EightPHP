...
$lang = array
(
	'there_can_be_only_one' =>	'There can be only one instance of Eight per page request',
	...
	'no_controller'         =>	'Eight was not able to determine a controller to process this request: %s',
	'page_not_found'        =>	'The page you requested, %s, could not be found.',
	'stats_footer'          =>	'Loaded in {execution_time} seconds, using {memory_usage} of memory. Generated by Eight v{eight_version}.',
	...
	'resource_not_found'	=>	'The requested %s, %s, could not be loaded. It probably doesn\'t exist. Check your path.',
