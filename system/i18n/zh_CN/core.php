...
$lang = array
(
	'there_can_be_only_one' => '每个请求页面只允许一个Eight实例.',
	...
	'no_controller'         => 'Eight没有找到处理该请求的控制器: %s',
	'page_not_found'        => '您请求的页面 <tt>%s</tt>, 不存在.',
	'stats_footer'          => '页面加载 {execution_time} 秒, 使用内存 {memory_usage} . Generated by Eight v{eight_version}.',
