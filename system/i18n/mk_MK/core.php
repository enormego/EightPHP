...
$lang = array
(
	'there_can_be_only_one' => 'Може да има само една инстанца на Eight при еден циклус.',
	...
	'no_controller'         => 'Eight не пронајде контролер за да го процесира ова барање: %s',
	'page_not_found'        => 'Страната која ја побаравте, <tt>%s</tt>, не е пронајдена.',
	'stats_footer'          => 'Вчитано за {execution_time} секунди, употребено {memory_usage} меморија. Креирано со Eight v{eight_version}.',
