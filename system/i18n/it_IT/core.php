...
$lang = array
(
	'there_can_be_only_one' => 'Ci può essere una sola istanza di Eight per ogni pagina richiesta.',
	...
	'no_controller'         => 'Eight non è in grado di determinare a quale controller inoltrare la richiesta: %s',
	'page_not_found'        => 'La pagina richiesta, <tt>%s</tt>, non è stata trovata.',
	'stats_footer'          => 'Caricato in {execution_time} secondi, usando {memory_usage} di memoria. Generato da Eight v{eight_version}.',
