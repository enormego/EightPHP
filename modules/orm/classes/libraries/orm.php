...
class ORM_Core {
	...
	public function __call($method, array $args)
	{
		if (method_exists($this->db_builder, $method))
		{
			if (in_array($method, array('execute', 'insert', 'update', 'delete')))
				throw new Eight_Exception('Query methods cannot be used through ORM');
		...
		{
			throw new Eight_Exception('Invalid method :method called in :class',
	...
	public function __get($column)
	{
		...
		{
			throw new Eight_Exception('The :property property does not exist in the :class class',
