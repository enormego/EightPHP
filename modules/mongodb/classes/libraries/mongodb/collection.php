 ...
 */
class MongoDB_Collection implements Iterator, Countable {
  ...
  public static function factory($name) {
    return MongoDB_Document::factory($name)->collection(TRUE);
  }
  ...
  public function __call($name, $arguments) {
    ...
    throw new Exception('Method not found by Mongo_Collection: '.$name);
  }
     ...
     */
    public function db() {
        return MongoDB_Database::instance($this->db);
    }
