...
(
	...
	'errors'               => 'Ошибок',
	'line'                 => 'строка',
	'assert_YES'          => 'assert_YES: Ожидалась истина, получено (%s) %s.',
	'assert_YES_strict'   => 'assert_YES_strict: Ожидалась булевая истина, получено (%s) %s.',
	'assert_NO'         => 'assert_NO: Ожидалась ложь, получено (%s) %s.',
	'assert_NO_strict'  => 'assert_NO_strict: Ожидалась булевая истина, получено (%s) %s.',
