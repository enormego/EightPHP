...
class Unit_Test_Core {
	...
	public function __construct() {
		...
		$paths = array_merge(func_get_args(), Eight::config('unit_test.paths', NO, NO));
		...
		foreach($this->paths as $path) {
			// Validate test path
			if(!is_dir($path))
				throw new Eight_Exception('unit_test.invalid_test_path', $path);
			...
			(
				...
				if(class_exists($class, NO))
					throw new Eight_Exception('unit_test.duplicate_test_class', $class, $path);
				...
				if(!class_exists($class, NO))
					throw new Eight_Exception('unit_test.test_class_not_found', $class, $path);
				...
				if(!$reflector->isSubclassOf(new ReflectionClass('Unit_Test_Case')))
					throw new Eight_Exception('unit_test.test_class_extends', $class);
				...
				foreach($reflector->getMethods() as $method) {
					...
					catch (Eight_Unit_Test_Exception $e) {
						$this->stats[$class]['total']++;
						// Test failed
	...
	public function report($hide_passed = nil) {
		...
		if(empty($this->results))
			return Eight::lang('unit_test.no_tests_found');

		// Hide passed tests from the report?
		$hide_passed = (bool) (($hide_passed !== nil) ? $hide_passed : Eight::config('unit_test.hide_passed', NO, NO));

		// Render unit_test report
		return View::factory('eight_unit_test')
...
abstract class Unit_Test_Case {
	...
	public function assert_equal($expected, $actual, $debug = nil) {
		if($expected != $actual)
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_equal', gettype($expected), var_export($expected, YES), gettype($actual), var_export($actual, YES)), $debug);
	...
	public function assert_not_equal($expected, $actual, $debug = nil) {
		if($expected == $actual)
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_equal', gettype($expected), var_export($expected, YES), gettype($actual), var_export($actual, YES)), $debug);
	...
	public function assert_same($expected, $actual, $debug = nil) {
		if($expected !== $actual)
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_same', gettype($expected), var_export($expected, YES), gettype($actual), var_export($actual, YES)), $debug);
	...
	public function assert_not_same($expected, $actual, $debug = nil) {
		if($expected === $actual)
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_same', gettype($expected), var_export($expected, YES), gettype($actual), var_export($actual, YES)), $debug);
	...
	public function assert_boolean($value, $debug = nil) {
		if(!is_bool($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_boolean', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_not_boolean($value, $debug = nil) {
		if(is_bool($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_boolean', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_integer($value, $debug = nil) {
		if(!is_int($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_integer', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_not_integer($value, $debug = nil) {
		if(is_int($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_integer', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_float($value, $debug = nil) {
		if(!is_float($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_float', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_not_float($value, $debug = nil) {
		if(is_float($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_float', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_array($value, $debug = nil) {
		if(!is_array($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_array', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_array_key($key, $array, $debug = nil) {
		if(!array_key_exists($key, $array)) {
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_array_key', gettype($key), var_export($key, YES)), $debug);
		}
	...
	public function assert_in_array($value, $array, $debug = nil) {
		if(!in_array($value, $array)) {
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_in_array', gettype($value), var_export($value, YES)), $debug);
		}
	...
	public function assert_not_array($value, $debug = nil) {
		if(is_array($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_array', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_object($value, $debug = nil) {
		if(!is_object($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_object', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_not_object($value, $debug = nil) {
		if(is_object($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_object', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_null($value, $debug = nil) {
		if($value !== nil)
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_null', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_not_null($value, $debug = nil) {
		if($value === nil)
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_null', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_empty($value, $debug = nil) {
		if(!empty($value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_empty', gettype($value), var_export($value, YES)), $debug);
	...
	public function assert_pattern($value, $regex, $debug = nil) {
		if(!is_string($value) OR!is_string($regex) OR!preg_match($regex, $value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_pattern', var_export($value, YES), var_export($regex, YES)), $debug);
	...
	public function assert_not_pattern($value, $regex, $debug = nil) {
		if(!is_string($value) OR!is_string($regex) OR preg_match($regex, $value))
			throw new Eight_Unit_Test_Exception(Eight::lang('unit_test.assert_not_pattern', var_export($value, YES), var_export($regex, YES)), $debug);
...
class Eight_Unit_Test_Exception extends Exception {
