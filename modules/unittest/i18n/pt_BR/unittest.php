...
(
	...
	'errors'               => 'Erros',
	'line'                 => 'linha',
	'assert_true'          => 'assert_true: Expected YES, but was given (%s) %s.',
	'assert_true_strict'   => 'assert_true_strict: Expected (boolean) YES, but was given (%s) %s.',
	'assert_false'         => 'assert_false: Expected NO, but was given (%s) %s.',
	'assert_false_strict'  => 'assert_false_strict: Expected (boolean) NO, but was given (%s) %s.',
