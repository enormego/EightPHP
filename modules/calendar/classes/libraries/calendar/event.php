 ...
 */
class Calendar_Event_Core extends Calendar_Event_Observer {
	 ...
	 *
	 * To unset a condition, call condition with a value of nil.
	 *
	 * @chainable
	...
	public function notify($data) {
		...
		foreach($conditions as $key => $value) {
			if($key === 'callback') {
				// Callbacks are tested on a YES/NO basis
				$value = YES;
			}
